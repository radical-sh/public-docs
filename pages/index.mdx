...
Radical.sh is much more than a skeleton generator, radical captures the domain model in a specification which can be further used to generate layers of code from API's, Events and Respositories.
